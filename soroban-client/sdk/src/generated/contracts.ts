...
export const GENERATED_CONTRACT_SPECS = {
  eventManager: {
    ...
    methods: [
      {
        name: "initialize",
        args: [{ name: "ticket_factory", type: "Address" }],
        returns: "()",
        mutates: true,
      },
      {
        name: "create_event",
        args: [{ name: "params", type: "CreateEventParams" }],
        returns: "u32",
        mutates: true,
      },
      {
        ...
        args: [
          ...
          { name: "start_date", type: "u64" },
          { name: "end_date", type: "u64" },
          { name: "ticket_price", type: "i128" },
          { name: "total_tickets", type: "u128" },
      ...
      },
      {
        ...
        args: [
          { name: "event_id", type: "u32" },
          { name: "theme", type: "Option<String>" },
          { name: "ticket_price", type: "Option<i128>" },
          { name: "total_tickets", type: "Option<u128>" },
          { name: "start_date", type: "Option<u64>" },
          { name: "end_date", type: "Option<u64>" },
        ],
        returns: "()",
        mutates: true,
      },
    ...
    methods: [
      {
        ...
        args: [
          ...
          { name: "ticket_wasm_hash", type: "BytesN<32>" },
        ],
        returns: "()",
        mutates: true,
      },
  ...
  ticketNft: {
    ...
    methods: [
      {
        name: "__constructor",
        args: [{ name: "minter", type: "Address" }],
        returns: "()",
        mutates: true,
      },
      {
        name: "mint_ticket_nft",
        args: [{ name: "recipient", type: "Address" }],
        returns: "u128",
        mutates: true,
      },
      {
        name: "owner_of",
        args: [{ name: "token_id", type: "u128" }],
        returns: "Address",
        mutates: false,
      },
      {
  ...
  tbaRegistry: {
    ...
    methods: [
      {
        name: "__constructor",
        args: [{ name: "tba_account_wasm_hash", type: "BytesN<32>" }],
        returns: "()",
        mutates: true,
      },
      {
        name: "get_account",
        args: [
          { name: "implementation_hash", type: "BytesN<32>" },
  ...
  tbaAccount: {
    ...
    methods: [
      ...
      { name: "nonce", args: [], returns: "u64", mutates: false },
      {
        ...
        args: [
          { name: "to", type: "Address" },
          { name: "func", type: "Symbol" },
          { name: "args", type: "Vec<Val>" },
        ],
        returns: "Vec<Val>",
        mutates: true,
      },
      {
        name: "__check_auth",
        args: [
          { name: "signature_payload", type: "BytesN<32>" },
          { name: "signatures", type: "Vec<BytesN<64>>" },
          { name: "auth_context", type: "Vec<Context>" },
        ],
        returns: "()",
        mutates: true,
      },
